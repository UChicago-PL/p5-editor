...
if (process.env.NODE_ENV === 'development') {
  ...
  users.forEach((user) => {
    ...
    UserAllowlist.create({ github: user, type: 'user', studyParticipant: false, edition: 'csp21' }, cb);
    UserAllowlist.create({ github: user, type: 'user', studyParticipant: false, edition: 'imm21' }, cb);
  });
}
