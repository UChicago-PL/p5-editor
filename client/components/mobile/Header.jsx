...
const textColor = ({ transparent, inverted }) =>
  prop(transparent === false && inverted === true ? 'MobilePanel.default.background' : 'primaryTextColor');
...
const Header = ({ title, subtitle, leftButton, children, transparent, inverted, slim, fixed }) => (
