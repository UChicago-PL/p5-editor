...
test('A bunch of shapetoolboxes should be removed', () => {
  expect(strip(exampleInput)).toBe(expectedOutput);
});
...
test.only('A bunch of shapetoolboxes should be removed', () => {
  expect(strip(smallExampleInput)).toBe(expectedOutput2);
});
