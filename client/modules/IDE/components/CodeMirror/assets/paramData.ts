  ...
  p5: {
      ...
      params: [
        {
          name: 'color',
          description:
            '<p><a href="#/p5.Color">p5.Color</a> object, color components,          or CSS color</p>\n',
      ...
      overloads: [
        {
          params: [
            ...
            {
              name: 'alpha',
              description: '<p>alpha value relative to current color range  (default is 0-255)</p>\n',
              type: 'Number',
              optional: true
            }
          ]
          ...
          params: [
            {
              name: 'values',
              description:
                '<p>an array containing the red,green,blue &  and alpha components of the color</p>\n',
              type: 'Number[]'
            }
          ]
        },
        ...
        },
        {
          params: [
            ...
            },
            {
              name: 'a',
              description:
                '<p>opacity of the background relative to current  color range (default is 0-255)</p>\n',
              type: 'Number',
              optional: true
            }
          ],
          ...
          params: [
            {
              name: 'image',
              description:
                '<p>image created with <a href="#/p5/loadImage">loadImage()</a> or <a href="#/p5/createImage">createImage()</a>,  to set as background  (must be same size as the sketch window)</p>\n',
              type: 'p5.Image'
            },
            {
              name: 'a',
      ...
      overloads: [
        ...
        },
        {
          params: [
            ...
            {
              name: 'max1',
              description: '<p>range for the red or hue depending on the   current color mode</p>\n',
              type: 'Number'
            },
            {
              name: 'max2',
              description: '<p>range for the green or saturation depending   on the current color mode</p>\n',
              type: 'Number'
            },
            {
              name: 'max3',
              description:
                '<p>range for the blue or brightness/lightness   depending on the current color mode</p>\n',
              type: 'Number'
            },
            {
              name: 'maxA',
      ...
      params: [
        {
          name: 'strengthFill',
          description:
            "<p>A number (0-255) for the strength of erasing for a shape's fill.         This will default to 255 when no argument is given, which         is full strength.</p>\n",
          type: 'Number',
          optional: true
        },
        {
          name: 'strengthStroke',
          description:
            "<p>A number (0-255) for the strength of erasing for a shape's stroke.         This will default to 255 when no argument is given, which         is full strength.</p>\n",
          type: 'Number',
          optional: true
        }
      ],
      ...
      params: [
        {
          name: 'kind',
          description:
            '<p>either POINTS, LINES, TRIANGLES, TRIANGLE_FAN TRIANGLE_STRIP, QUADS, QUAD_STRIP or TESS</p>\n',
          type: 'Constant',
          optional: true
        }
      ],
    ...
    createGraphics: {
      ...
      params: [
        ...
        {
          name: 'renderer',
          description: '<p>either P2D or WEBGL    undefined defaults to p2d</p>\n',
          type: 'Constant',
          optional: true
        }
      ],
    ...
    select: {
      ...
      params: [
        ...
        },
        {
          name: 'container',
          description:
            '<p>CSS selector string, <a href="#/p5.Element">p5.Element</a>, or              HTML element to search within</p>\n',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when the value of an element changes. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when any user input is detected within the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5',
    ...
    createA: {
      ...
      params: [
        ...
        {
          name: 'target',
          description: '<p>target where new link should open,  could be _blank, _self, _parent, _top.</p>\n',
          type: 'String',
          optional: true
        }
      ],
    ...
    createVideo: {
      ...
      params: [
        {
          name: 'src',
          description: '<p>path to a video file, or array of paths for  supporting different browsers</p>\n',
          type: 'String|String[]'
        },
        {
          name: 'callback',
          description:
            "<p>callback function to be called upon  'canplaythrough' event fire, that is, when the  browser can play the media, and estimates that  enough data has been loaded to play the media  up to its end without having to stop for  further buffering of content</p>\n",
          type: 'Function',
          optional: true
        }
      ],
    ...
    createAudio: {
      ...
      params: [
        {
          name: 'src',
          description: '<p>path to an audio file, or array of paths  for supporting different browsers</p>\n',
          type: 'String|String[]',
          optional: true
        },
        {
      ...
      params: [
        {
          name: 'type',
          description:
            '<p>type of capture, either VIDEO or    AUDIO if none specified, default both,    or a Constraints object</p>\n',
          type: 'String|Constant|Object'
        },
        {
          name: 'callback',
          description: '<p>function to be called once    stream has loaded</p>\n',
          type: 'Function',
          optional: true
        }
      ],
      ...
      overloads: [
        {
          params: [
            {
              name: 'selectedCanvas',
              description: '<p>a variable  representing a specific html5 canvas (optional)</p>\n',
    ...
    saveFrames: {
      ...
      params: [
        ...
        },
        {
          name: 'callback',
          description:
            '<p>A callback function that will be executed  to handle the image data. This function  should accept an array as argument. The  array will contain the specified number of  frames of objects. Each object has three  properties: imageData - an  image/octet-stream, filename and extension.</p>\n',
          type: 'Function(Array)',
          optional: true
        }
      ],
    ...
    loadImage: {
      ...
      params: [
        ...
        },
        {
          name: 'successCallback',
          description:
            '<p>Function to be called once the image is loaded. Will be passed the <a href="#/p5.Image">p5.Image</a>.</p>\n',
          type: 'function(p5.Image)',
          optional: true
        },
        {
          name: 'failureCallback',
          description: '<p>called with event error if the image fails to load.</p>\n',
          type: 'Function(Event)',
          optional: true
        }
      ],
        ...
        },
        {
          params: [
            ...
            },
            {
              name: 'sHeight',
              description:
                '<p>the height of the subsection of the source image to draw into the destination rectangle</p>\n',
              type: 'Number',
              optional: true
            }
          ]
      ...
      params: [
        {
          name: 'filterType',
          description:
            '<p>either THRESHOLD, GRAY, OPAQUE, INVERT, POSTERIZE, BLUR, ERODE, DILATE or BLUR. See Filters.js for docs on each available filter</p>\n',
          type: 'Constant'
        },
        {
          name: 'filterParam',
          description: '<p>an optional parameter unique to each filter, see above</p>\n',
          type: 'Number',
          optional: true
        }
      ],
    ...
    set: {
      ...
      params: [
        ...
        },
        {
          name: 'c',
          description:
            '<p>insert a grayscale value | a pixel array | a <a href="#/p5.Color">p5.Color</a> object | a <a href="#/p5.Image">p5.Image</a> to copy</p>\n',
      ...
      overloads: [
        {
          params: [
            ...
            },
            {
              name: 'callback',
              description:
                '<p>function to be executed after     <a href="#/p5/loadJSON">loadJSON()</a> completes, data is passed     in as first argument</p>\n',
              type: 'Function',
              optional: true
            },
            {
              name: 'errorCallback',
              description:
                '<p>function to be executed if     there is an error, response is passed     in as first argument</p>\n',
              type: 'Function',
              optional: true
            }
          ]
    ...
    loadStrings: {
      ...
      params: [
        ...
        },
        {
          name: 'callback',
          description:
            '<p>function to be executed after <a href="#/p5/loadStrings">loadStrings()</a>    completes, Array is passed in as first    argument</p>\n',
          type: 'Function',
          optional: true
        },
        {
    ...
    loadTable: {
      ...
      params: [
        ...
        },
        {
          name: 'extension',
          description:
            '<p>parse the table by comma-separated values "csv", semicolon-separated       values "ssv", or tab-separated values "tsv"</p>\n',
          type: 'String',
          optional: true
        },
        {
        ...
        },
        {
          name: 'callback',
          description:
            '<p>function to be executed after       <a href="#/p5/loadTable">loadTable()</a> completes. On success, the       <a href="#/p5.Table">Table</a> object is passed in as the       first argument.</p>\n',
          type: 'Function',
          optional: true
        },
        {
    ...
    loadXML: {
      ...
      params: [
        ...
        },
        {
          name: 'callback',
          description:
            '<p>function to be executed after <a href="#/p5/loadXML">loadXML()</a>    completes, XML object is passed in as    first argument</p>\n',
          type: 'Function',
          optional: true
        },
        {
    ...
    loadBytes: {
      ...
      params: [
        ...
        },
        {
          name: 'callback',
          description:
            '<p>function to be executed after <a href="#/p5/loadBytes">loadBytes()</a>     completes</p>\n',
          type: 'Function',
          optional: true
        },
        {
          name: 'errorCallback',
          description: '<p>function to be executed if there     is an error</p>\n',
          type: 'Function',
          optional: true
        }
      ],
      ...
      overloads: [
        {
          params: [
            ...
            {
              name: 'datatype',
              description: '<p>"json", "jsonp", "binary", "arrayBuffer",     "xml", or "text"</p>\n',
              type: 'String',
              optional: true
            },
            {
            ...
            },
            {
              name: 'callback',
              description:
                '<p>function to be executed after     <a href="#/p5/httpGet">httpGet()</a> completes, data is passed in     as first argument</p>\n',
              type: 'Function',
              optional: true
            },
            {
      ...
      overloads: [
        {
          params: [
            ...
            },
            {
              name: 'datatype',
              description:
                '<p>"json", "jsonp", "xml", or "text".     If omitted, <a href="#/p5/httpPost">httpPost()</a> will guess.</p>\n',
              type: 'String',
              optional: true
            },
            {
            ...
            },
            {
              name: 'callback',
              description:
                '<p>function to be executed after     <a href="#/p5/httpPost">httpPost()</a> completes, data is passed in     as first argument</p>\n',
              type: 'Function',
              optional: true
            },
            {
      ...
      overloads: [
        {
          params: [
            ...
            {
              name: 'method',
              description: '<p>either "GET", "POST", or "PUT",     defaults to "GET"</p>\n',
              type: 'String',
              optional: true
            },
            {
        ...
        },
        {
          params: [
            ...
            },
            {
              name: 'options',
              description:
                '<p>Request object options as documented in the     "fetch" API\n<a href="https://developer.mozilla.org/en/docs/Web/API/Fetch_API">reference</a></p>\n',
              type: 'Object'
            },
            {
              name: 'callback',
      ...
      params: [
        {
          ...
          description:
            '<p>If filename is provided, will             save canvas as an image with             either png or jpg extension             depending on the filename.             If object is provided, will             save depending on the object             and filename (see examples             above).</p>\n',
          type: 'Object|String',
          optional: true
        },
        {
          name: 'filename',
          description:
            '<p>If an object is provided as the first   parameter, then the second parameter   indicates the filename,   and should include an appropriate   file extension (see examples above).</p>\n',
          type: 'String',
          optional: true
        },
        {
    ...
    saveJSON: {
      ...
      params: [
        ...
        },
        {
          name: 'optimize',
          description:
            '<p>If true, removes line breaks and spaces from the output file to optimize filesize (but not readability).</p>\n',
          type: 'Boolean',
          optional: true
        }
      ],
      ...
      overloads: [
        {
          params: [
            {
              name: 'horizAlign',
              description: '<p>horizontal alignment, either LEFT, CENTER, or RIGHT</p>\n',
              type: 'Constant'
            },
            {
              name: 'vertAlign',
              description: '<p>vertical alignment, either TOP, BOTTOM, CENTER, or BASELINE</p>\n',
              type: 'Constant',
              optional: true
            }
          ],
      ...
      overloads: [
        {
          params: [
            {
              name: 'theStyle',
              description: '<p>styling for text, either NORMAL, ITALIC, BOLD or BOLDITALIC</p>\n',
              type: 'Constant'
            }
          ],
          chainable: 1
    ...
    loadFont: {
      ...
      params: [
        ...
        },
        {
          name: 'callback',
          description:
            '<p>function to be executed after     <a href="#/p5/loadFont">loadFont()</a> completes</p>\n',
          type: 'Function',
          optional: true
        },
        {
          name: 'onError',
          description: '<p>function to be executed if     an error occurs</p>\n',
          type: 'Function',
          optional: true
        }
      ],
      ...
      overloads: [
        {
          params: [
            ...
            {
              name: 'left',
              description: '<p>number of digits to the left of the decimal point</p>\n',
              type: 'Integer|String',
              optional: true
            },
            {
              name: 'right',
              description: '<p>number of digits to the right of the decimal point</p>\n',
              type: 'Integer|String',
              optional: true
            }
          ]
    ...
    plane: {
      ...
      params: [
        ...
        {
          name: 'detailX',
          description: '<p>Optional number of triangle  subdivisions in x-dimension</p>\n',
          type: 'Integer',
          optional: true
        },
        {
          name: 'detailY',
          description: '<p>Optional number of triangle  subdivisions in y-dimension</p>\n',
          type: 'Integer',
          optional: true
        }
      ],
    ...
    cylinder: {
      ...
      params: [
        ...
        {
          name: 'detailX',
          description: '<p>number of subdivisions in x-dimension;    default is 24</p>\n',
          type: 'Integer',
          optional: true
        },
        {
          name: 'detailY',
          description: '<p>number of subdivisions in y-dimension;    default is 1</p>\n',
          type: 'Integer',
          optional: true
        },
        {
    ...
    cone: {
      ...
      params: [
        ...
        {
          name: 'detailX',
          description: '<p>number of segments,  the more segments the smoother geometry  default is 24</p>\n',
          type: 'Integer',
          optional: true
        },
        {
          name: 'detailY',
          description: '<p>number of segments,  the more segments the smoother geometry  default is 1</p>\n',
          type: 'Integer',
          optional: true
        },
        {
    ...
    ellipsoid: {
      ...
      params: [
        ...
        },
        {
          name: 'detailX',
          description:
            '<p>number of segments,     the more segments the smoother geometry     default is 24. Avoid detail number above     150, it may crash the browser.</p>\n',
          type: 'Integer',
          optional: true
        },
        {
          name: 'detailY',
          description:
            '<p>number of segments,     the more segments the smoother geometry     default is 16. Avoid detail number above     150, it may crash the browser.</p>\n',
          type: 'Integer',
          optional: true
        }
      ],
    ...
    torus: {
      ...
      params: [
        ...
        },
        {
          name: 'detailX',
          description:
            '<p>number of segments in x-dimension, the more segments the smoother geometry default is 24</p>\n',
          type: 'Integer',
          optional: true
        },
        {
          name: 'detailY',
          description:
            '<p>number of segments in y-dimension, the more segments the smoother geometry default is 16</p>\n',
          type: 'Integer',
          optional: true
        }
      ],
          ...
          params: [
            {
              name: 'color',
              description:
                '<p>color Array, CSS color string,              or <a href="#/p5.Color">p5.Color</a> value</p>\n',
      ...
      overloads: [
        {
          params: [
            ...
            {
              name: 'normalize',
              description: '<p>If true, scale the model to a       standardized size when loading</p>\n',
              type: 'Boolean'
            },
            {
              name: 'successCallback',
              description:
                '<p>Function to be called      once the model is loaded. Will be passed      the 3D model object.</p>\n',
              type: 'function(p5.Geometry)',
              optional: true
            },
            {
              name: 'failureCallback',
              description: '<p>called with event error if          the model fails to load.</p>\n',
              type: 'Function(Event)',
              optional: true
            },
            {
              name: 'fileType',
              description:
                '<p>The file extension of the model       (<code>.stl</code>, <code>.obj</code>).</p>\n',
              type: 'String',
              optional: true
            }
          ]
      ...
      params: [
        {
          name: 'element(s)',
          description:
            '<p>This argument can be an Element,    Selector String, NodeList, p5.Element,    jQuery Element, or an Array of any of those.</p>\n',
          type: 'Element|Array',
          optional: true
        },
        {
    ...
    outputVolume: {
      ...
      params: [
        {
          name: 'volume',
          description: '<p>Volume (amplitude) between 0.0     and 1.0 or modulating signal/oscillator</p>\n',
          type: 'Number|Object'
        },
        {
          name: 'rampTime',
        ...
        {
          name: 'timeFromNow',
          description: '<p>Schedule this event to happen at t seconds in the future</p>\n',
          type: 'Number',
          optional: true
        }
      ],
    ...
    freqToMidi: {
      ...
      params: [
        {
          name: 'frequency',
          description: '<p>A freqeuncy, for example, the "A" above Middle C is 440Hz</p>\n',
          type: 'Number'
        }
      ],
      class: 'p5',
      ...
      params: [
        {
          name: 'path',
          description:
            "<p>Path to the sound file, or an array with    paths to soundfiles in multiple formats    i.e. ['sound.ogg', 'sound.mp3'].    Alternately, accepts an object: either    from the HTML5 File API, or a p5.File.</p>\n",
          type: 'String|Array'
        },
        {
          name: 'successCallback',
        ...
        {
          name: 'errorCallback',
          description: '<p>Name of a function to call if there is      an error loading the file.</p>\n',
          type: 'Function',
          optional: true
        },
        {
          name: 'whileLoading',
          description:
            '<p>Name of a function to call while file is loading. This function will receive the percentage loaded so far, from 0.0 to 1.0.</p>\n',
          type: 'Function',
          optional: true
        }
      ],
    ...
    createConvolver: {
      ...
      params: [
        ...
        },
        {
          name: 'callback',
          description:
            '<p>function to call if loading is successful.    The object will be passed in as the argument    to the callback function.</p>\n',
          type: 'Function',
          optional: true
        },
        {
          name: 'errorCallback',
          description:
            '<p>function to call if loading is not successful.    A custom error will be passed in as the argument    to the callback function.</p>\n',
          type: 'Function',
          optional: true
        }
      ],
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when mouse is pressed over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when mouse is double clicked over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when mouse is scrolled over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when mouse is released over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when mouse is clicked over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a mouse moves over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a mouse moves onto the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a mouse moves off of an element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a touch starts over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a touch moves over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a touch ends over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a file is dragged over the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'fxn',
          description:
            '<p>function to be fired when a file is dragged off the element. if <code>false</code> is passed instead, the previously firing function will no longer fire.</p>\n',
          type: 'Function|Boolean'
        }
      ],
      class: 'p5.Element',
      ...
      params: [
        {
          name: 'callback',
          description:
            '<p>function to call when the  soundfile has ended. The  media element will be passed  in as the argument to the  callback.</p>\n',
          type: 'Function'
        }
      ],
      class: 'p5.MediaElement',
      ...
      params: [
        {
          name: 'time',
          description:
            "<p>Time in seconds, relative to this media  element's playback. For example, to trigger  an event every time playback reaches two  seconds, pass in the number 2. This will be  passed as the first parameter to  the callback function.</p>\n",
          type: 'Number'
        },
        {
          name: 'callback',
          description:
            '<p>Name of a function that will be  called at the given time. The callback will  receive time and (optionally) param as its  two parameters.</p>\n',
          type: 'Function'
        },
        {
          name: 'value',
          description: '<p>An object to be passed as the  second parameter to the  callback function.</p>\n',
          type: 'Object',
          optional: true
        }
      ],
      ...
      overloads: [
        {
          params: [
            {
              name: 'x',
              description: '<p>x-offset of the target update area for the   underlying canvas</p>\n',
              type: 'Integer'
            },
            {
              name: 'y',
              description: '<p>y-offset of the target update area for the   underlying canvas</p>\n',
              type: 'Integer'
            },
            {
              name: 'w',
              description: '<p>height of the target update area for the   underlying canvas</p>\n',
              type: 'Integer'
            },
            {
              name: 'h',
    ...
    set: {
      ...
      params: [
        ...
        },
        {
          name: 'a',
          description:
            '<p>grayscale value | pixel array | a <a href="#/p5.Color">p5.Color</a> | image to copy</p>\n',
          type: 'Number|Number[]|Object'
        }
      ],
      class: 'p5.Image',
      ...
      params: [
        {
          name: 'filterType',
          description:
            '<p>either THRESHOLD, GRAY, OPAQUE, INVERT, POSTERIZE, ERODE, DILATE or BLUR. See Filters.js for docs on each available filter</p>\n',
          type: 'Constant'
        },
        {
          name: 'filterParam',
  ...
  'p5.Table': {
    ...
    findRow: {
      ...
      params: [
        ...
        {
          name: 'column',
          description: '<p>ID number or title of the column to search</p>\n',
          type: 'Integer|String'
        }
      ],
      class: 'p5.Table',
    ...
    matchRow: {
      ...
      params: [
        ...
        {
          name: 'column',
          description: '<p>The column ID (number) or   title (string)</p>\n',
          type: 'String|Integer'
        }
      ],
      class: 'p5.Table',
    ...
    removeTokens: {
      ...
      params: [
        ...
        {
          name: 'column',
          description: '<p>Column ID (number)   or name (string)</p>\n',
          type: 'String|Integer',
          optional: true
        }
      ],
    ...
    set: {
      ...
      params: [
        ...
        {
          name: 'column',
          description: '<p>column ID (Number)    or title (String)</p>\n',
          type: 'String|Integer'
        },
        {
          name: 'value',
      ...
      params: [
        {
          name: 'headerColumn',
          description:
            '<p>Name of the column which should be used to   title each row object (optional)</p>\n',
          type: 'String',
          optional: true
        }
      ],
  ...
  'p5.TableRow': {
    ...
    setNum: {
      ...
      params: [
        ...
        {
          name: 'value',
          description: '<p>The value to be stored    as a Float</p>\n',
          type: 'Number|String'
        }
      ],
      class: 'p5.TableRow',
    ...
    setString: {
      ...
      params: [
        ...
        {
          name: 'value',
          description: '<p>The value to be stored    as a String</p>\n',
  ...
  'p5.Vector': {
    ...
    fromAngles: {
      ...
      params: [
        ...
        {
          name: 'phi',
          description: '<p>the azimuthal angle, in radians    (zero is out of the screen)</p>\n',
          type: 'Number'
        },
        {
          name: 'length',
    ...
    textBounds: {
      ...
      params: [
        ...
        },
        {
          name: 'options',
          description:
            "<p>opentype options (optional) opentype fonts contains alignment and baseline options. Default is 'LEFT' and 'alphabetic'</p>\n",
          type: 'Object',
          optional: true
        }
      ],
  ...
  'p5.SoundFile': {
    ...
    play: {
      ...
      params: [
        ...
        {
          name: 'amp',
          description: '<p>(optional) amplitude (volume)      of playback</p>\n',
          type: 'Number',
          optional: true
        },
        {
    ...
    pause: {
      ...
      params: [
        {
          name: 'startTime',
          description: '<p>(optional) schedule event to occur   seconds from now</p>\n',
          type: 'Number',
          optional: true
        }
      ],
    ...
    stop: {
      ...
      params: [
        {
          name: 'startTime',
          description: '<p>(optional) schedule event to occur  in seconds from now</p>\n',
          type: 'Number',
          optional: true
        }
      ],
    ...
    pan: {
      ...
      params: [
        ...
        {
          name: 'timeFromNow',
          description: '<p>schedule this event to happen  seconds from now</p>\n',
          type: 'Number',
          optional: true
        }
      ],
      ...
      params: [
        {
          name: 'playbackRate',
          description:
            '<p>Set the playback rate. 1.0 is normal,     .5 is half-speed, 2.0 is twice as fast.     Values less than zero play backwards.</p>\n',
          type: 'Number',
          optional: true
        }
      ],
    ...
    onended: {
      ...
      params: [
        {
          name: 'callback',
          description: '<p>function to call when the  soundfile has ended.</p>\n',
          type: 'Function'
        }
      ],
      class: 'p5.SoundFile',
  ...
  'p5.Amplitude': {
    setInput: {
      ...
      params: [
        {
          name: 'snd',
          description: '<p>set the sound source       (optional, defaults to       main output)</p>\n',
          type: 'SoundObject|undefined',
          optional: true
        },
        {
          name: 'smoothing',
          description: '<p>a range between 0.0 and 1.0        to smooth amplitude readings</p>\n',
  ...
  'p5.FFT': {
    ...
    waveform: {
      ...
      params: [
        ...
        },
        {
          name: 'precision',
          description:
            '<p>If any value is provided, will return results  in a Float32 Array which is more precise  than a regular array.</p>\n',
          type: 'String',
          optional: true
        }
      ],
    ...
    analyze: {
      ...
      params: [
        {
          name: 'bins',
          description: '<p>Must be a power of two between 16 and 1024. Defaults to 1024.</p>\n',
          type: 'Number',
          optional: true
        },
        {
          name: 'scale',
          description:
            '<p>If "dB," returns decibel float measurements between -140 and 0 (max). Otherwise returns integers from 0-255.</p>\n',
          type: 'Number',
          optional: true
        }
      ],
      ...
      params: [
        {
          name: 'frequency1',
          description:
            '<p>Will return a value representing    energy at this frequency. Alternately,    the strings "bass", "lowMid" "mid",    "highMid", and "treble" will return    predefined frequency ranges.</p>\n',
          type: 'Number|String'
        },
        {
          name: 'frequency2',
          description:
            '<p>If a second frequency is given,    will return average amount of    energy that exists between the    two frequencies.</p>\n',
          type: 'Number',
          optional: true
        }
      ],
    ...
    smooth: {
      ...
      params: [
        {
          name: 'smoothing',
          description: '<p>0.0 < smoothing < 1.0.   Defaults to 0.8.</p>\n',
          type: 'Number'
        }
      ],
      class: 'p5.FFT',
  ...
  'p5.Oscillator': {
    ...
    amp: {
      ...
      params: [
        {
          name: 'vol',
          description: '<p>between 0 and 1.0  or a modulating signal/oscillator</p>\n',
          type: 'Number|Object'
        },
        {
          name: 'rampTime',
    ...
    freq: {
      ...
      params: [
        {
          name: 'Frequency',
          description: '<p>Frequency in Hz        or modulating signal/oscillator</p>\n',
          type: 'Number|Object'
        },
        {
          name: 'rampTime',
        ...
        {
          name: 'timeFromNow',
          description: '<p>Schedule this event to happen   at x seconds from now</p>\n',
          type: 'Number',
          optional: true
        }
      ],
  ...
  'p5.Envelope': {
    ...
    set: {
      ...
      params: [
        {
          name: 'attackTime',
          description: '<p>Time (in seconds) before level reaches attackLevel</p>\n',
          type: 'Number'
        },
        {
          name: 'attackLevel',
          description: '<p>Typically an amplitude between 0.0 and 1.0</p>\n',
          type: 'Number'
        },
        {
          name: 'decayTime',
        ...
        {
          name: 'decayLevel',
          description: '<p>Amplitude (In a standard ADSR envelope, decayLevel = sustainLevel)</p>\n',
          type: 'Number'
        },
        {
          name: 'releaseTime',
    ...
    setADSR: {
      ...
      params: [
        {
          name: 'attackTime',
          description: '<p>Time (in seconds before envelope    reaches Attack Level</p>\n',
          type: 'Number'
        },
        {
          name: 'decayTime',
          description: '<p>Time (in seconds) before envelope    reaches Decay/Sustain Level</p>\n',
          type: 'Number',
          optional: true
        },
        {
    ...
    setInput: {
      ...
      params: [
        {
          name: 'inputs',
          description: '<p>A p5.sound object or    Web Audio Param.</p>\n',
          type: 'Object',
          optional: true,
          multiple: true
        }
  ...
  'p5.AudioIn': {
    ...
    start: {
      ...
      params: [
        {
          name: 'successCallback',
          description: '<p>Name of a function to call on    success.</p>\n',
          type: 'Function',
          optional: true
        },
        {
          name: 'errorCallback',
          description:
            '<p>Name of a function to call if    there was an error. For example,    some browsers do not support    getUserMedia.</p>\n',
          type: 'Function',
          optional: true
        }
      ],
    ...
    getLevel: {
      ...
      params: [
        {
          name: 'smoothing',
          description: '<p>Smoothing is 0.0 by default.   Smooths values based on previous values.</p>\n',
          type: 'Number',
          optional: true
        }
      ],
      ...
      params: [
        {
          name: 'successCallback',
          description:
            '<p>This callback function handles the sources when they       have been enumerated. The callback function       receives the deviceList array as its only argument</p>\n',
          type: 'Function',
          optional: true
        },
        {
          name: 'errorCallback',
          description: '<p>This optional callback receives the error     message as its argument.</p>\n',
          type: 'Function',
          optional: true
        }
      ],
    ...
    process: {
      ...
      params: [
        ...
        },
        {
          name: 'delayTime',
          description:
            '<p>Time (in seconds) of the delay/echo.   Some browsers limit delayTime to   1 second.</p>\n',
          type: 'Number',
          optional: true
        },
        {
          name: 'feedback',
          description:
            '<p>sends the delay back through itself   in a loop that decreases in volume   each time.</p>\n',
          type: 'Number',
          optional: true
        },
        {
          name: 'lowPass',
          description:
            '<p>Cutoff frequency. Only frequencies   below the lowPass will be part of the   delay.</p>\n',
          type: 'Number',
          optional: true
        }
      ],
      ...
      params: [
        {
          name: 'feedback',
          description:
            '<p>0.0 to 1.0, or an object such as an  Oscillator that can be used to  modulate this param</p>\n',
          type: 'Number|Object'
        }
      ],
      class: 'p5.Delay',
      ...
      params: [
        {
          name: 'cutoffFreq',
          description:
            '<p>A lowpass filter will cut off any  frequencies higher than the filter frequency.</p>\n',
          type: 'Number|Object'
        },
        {
          name: 'res',
          description:
            '<p>Resonance of the filter frequency  cutoff, or an object (i.e. a p5.Oscillator)  that can be used to modulate this parameter.  High numbers (i.e. 15) will produce a resonance,  low numbers (i.e. .2) will produce a slope.</p>\n',
          type: 'Number|Object'
        }
      ],
      class: 'p5.Delay',
  ...
  'p5.Part': {
    ...
    onStep: {
      ...
      params: [
        {
          name: 'callback',
          description: '<p>The name of the callback  you want to fire  on every beat/tatum.</p>\n',
          type: 'Function'
        }
      ],
      class: 'p5.Part',
    ...
    process: {
      ...
      params: [
        ...
        },
        {
          name: 'attack',
          description:
            '<p>The amount of time (in seconds) to reduce the gain by 10dB, default = .003, range 0 - 1</p>\n',
          type: 'Number',
          optional: true
        },
        {
          name: 'knee',
          description:
            '<p>A decibel value representing the range above the threshold where the curve smoothly transitions to the "ratio" portion. default = 30, range 0 - 40</p>\n',
          type: 'Number',
          optional: true
        },
        {
          name: 'ratio',
          description:
            '<p>The amount of dB change in input for a 1 dB change in output default = 12, range 1 - 20</p>\n',
          type: 'Number',
          optional: true
        },
        {
          name: 'threshold',
          description:
            '<p>The decibel value above which the compression will start taking effect default = -24, range -100 - 0</p>\n',
          type: 'Number',
          optional: true
        },
        {
          name: 'release',
          description:
            '<p>The amount of time (in seconds) to increase the gain by 10dB default = .25, range 0 - 1</p>\n',
          type: 'Number',
          optional: true
        }
      ],
  ...
  'p5.PeakDetect': {
    ...
    onPeak: {
      ...
      params: [
        {
          name: 'callback',
          description: '<p>Name of a function that will  be called when a peak is  detected.</p>\n',
          type: 'Function'
        },
        {
          name: 'val',
          description: '<p>Optional value to pass  into the function when  a peak is detected.</p>\n',
          type: 'Object',
          optional: true
        }
      ],
  ...
  'p5.SoundRecorder': {
    ...
    record: {
      ...
      params: [
        ...
        {
          name: 'callback',
          description: '<p>The name of a function that will be    called once the recording completes</p>\n',
          type: 'Function',
          optional: true
        }
      ],
  ...
  'p5.Distortion': {
    ...
    process: {
      ...
      params: [
        {
          name: 'amount',
          description: '<p>Unbounded distortion amount. Normal values range from 0-1.</p>\n',
          type: 'Number',
          optional: true,
          optdefault: '0.25'
        },
      ...
      params: [
        {
          name: 'note',
          description:
            '<p>the note you want to play, specified as a frequency in Hertz (Number) or as a midi value in Note/Octave format ("C4", "Eb3"...etc") See <a href = "https://github.com/Tonejs/Tone.js/wiki/Instruments"> Tone</a>. Defaults to 440 hz.</p>\n',
          type: 'String | Number'
        },
        {
          name: 'velocity',
      ...
      params: [
        {
          name: 'note',
          description:
            '<p>midi note on which attack should be triggered.    If no value is provided, all notes will be released.</p>\n',
          type: 'Number',
          optional: true
        },
        {
