...
class APIKeyForm extends React.Component {
  ...
  renderApiKeys() {
    ...
    if (hasApiKeys) {
      return <APIKeyList apiKeys={this.props.apiKeys} onRemove={this.removeKey} t={this.props.t} />;
    }
  ...
  render() {
    ...
    return (
      <div className="api-key-form">
        <p className="api-key-form__summary">{this.props.t('APIKeyForm.Summary')}</p>
        ...
        <div className="api-key-form__section">
          ...
          {keyWithToken && (
            <div className="api-key-form__new-token">
              ...
              <p className="api-key-form__new-token__info">{this.props.t('APIKeyForm.NewTokenInfo')}</p>
